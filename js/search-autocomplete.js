$(document).ready(function(){
	...
	$.ajax({
				url: '[system-view:internal]/render/page.act?id=449b5d3f0a00024e12439978feafa2b3&type=page[/system-view:internal][system-view:external]/search/blogs.xml[/system-view:external]',
				dataType: "xml",
